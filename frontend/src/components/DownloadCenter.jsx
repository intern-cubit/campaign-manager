...
const DownloadCenter = () => {
    const WA_BOMB_DOWNLOAD_URL = "https://github.com/intern-cubit/wa-bomb/releases/download/v0.0.5/WA-BOMB-Setup-0.0.5.exe";
    const EMAIL_STORM_DOWNLOAD_URL = "https://github.com/intern-cubit/mailstorm/releases/download/v0.0.6/MailStorm-Setup-0.0.6.exe";
